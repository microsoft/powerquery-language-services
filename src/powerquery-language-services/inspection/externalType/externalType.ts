...
export type TExternalTypeResolverFn = (request: TExternalTypeRequest) => PQP.Language.Type.TType | undefined;

export type TExternalInvocationTypeResolverFn = (
    request: ExternalInvocationTypeRequest,
) => PQP.Language.Type.TType | undefined;

export type TExternalValueTypeResolverFn = (request: ExternalValueTypeRequest) => PQP.Language.Type.TType | undefined;
...
export interface ExternalInvocationTypeRequest extends IExternalType {
    ...
    readonly args: ReadonlyArray<PQP.Language.Type.TType>;
}
